...
def process_dataset():
    ...
    # load dataset
    csv_file_path = '/scratch/wang.yan8/dataset_splitted.csv'
    ...
    processed_audio_data_path = f'/scratch/wang.yan8/processed_audio_dataset_small_without_xvectors'
    ...
    dataset_dict_path = f'/scratch/wang.yan8/dataset_dict_small_without_xvector'
